...
type Client = { id: number; name: string; first_name: string | null; phone: string; email: string | null };
...
export default function OrderEdit() {
  ...
  return (
    <Shell>
      <h1 className="text-xl font-semibold mb-4">Modifier la commande</h1>
